  ...
  <header className="absolute top-0 left z-10 flex w-full items-center bg-transparent navbar-fixed">
    <div className="container">
      <div className="relative flex items-center justify-between">
        <div className="px-4">
          <a href="#home" className="block py-6 text-lg font-semibold">{greeting.initialName}</a>
        </div>
        <div className="flex items-center px-4">
          ...
          <nav id="nav-menu" className="absolute right-4 top-full hidden w-full max-w-[250px] rounded-lg bg-white py-5 shadow-lg dark:bg-dark lg:static lg:block lg:max-w-full lg:rounded-none lg:bg-transparent lg:shadow-none lg:dark:bg-transparent">
